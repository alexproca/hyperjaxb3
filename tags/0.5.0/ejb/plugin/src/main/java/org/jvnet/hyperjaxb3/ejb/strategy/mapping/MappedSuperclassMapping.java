...
public class MappedSuperclassMapping implements ClassOutlineMapping<MappedSuperclass> {
	...
	public MappedSuperclass process(Mapping context, ClassOutline classOutline,
		...
		final MappedSuperclass entity = context.getCustomizing().getMappedSuperclass(classOutline);
		createMappedSuperclass(context, classOutline, entity);
		return entity;
	}
	
	public void createMappedSuperclass(Mapping context, ClassOutline classOutline,
			final MappedSuperclass mappedSuperclass) throws Exception {
...
*/
		createMappedSuperclass$Attributes(context, classOutline, mappedSuperclass);
	}
	
	public void createMappedSuperclass$Class(Mapping context, ClassOutline classOutline,
	...
	public void createMappedSuperclass$Attributes(Mapping context,
			ClassOutline classOutline, final MappedSuperclass mappedSuperclass) throws Exception {
